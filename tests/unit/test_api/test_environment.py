...
def test_add_project(client):
    ...
    response = client.Build.AddProject(
        True, True, "env_name", 1, "name", "type", "path",[1, 1], ["login1", "login2"],
        ["password1", "password2"], ["target_env1", "target_env2"]
        , ["context1", "context2"], ["branch1", "branch2"], ["interval1", "interval2"], [1, 1], [True, True],
        ["hooks1", "hooks2"], ["work_dir1", "work_dir2"],["target_node_group1", "target_node_group2"],
  [True, True] )
    client._get.assert_called_with(
        "AddProject",
        params={
...
def test_add_project_with_creds(client):
    ...
    response = client.Build.AddProjectWithCreds(
        True,True,"env_name",1,"name","type","path", ["target_env1","target_env2"],["login1","login2"],["password1","password2"]
,["context1","context2"] , ["branch1","branch2"],["interval1","interval2"] ,[1,1],[True,True],
    ["hooks1","hooks2"] , ["work_dir1","work_dir2"])
    client._get.assert_called_with(
        "AddProjectWithCreds",
        params={
            "autoUpdate": True,
...
def test_add_project_with_key(client):
    ...
    response = client.Build.AddProjectWithKey(
        True,True,"env_name",1,"name","type","path", ["target_env1","target_env2"],[1,1]
,["context1","context2"] , ["branch1","branch2"],["interval1","interval2"] ,[1,1],[True,True],
    ["hooks1","hooks2"] , ["work_dir1","work_dir2"])
    client._get.assert_called_with(
        "AddProjectWithKey",
...
def test_edit_project(client):
    ...
    response = client.Build.EditProject(
       "env_name", 1,1, "name", "type", "path",[1, 1], ["login1", "login2"],
        ["password1", "password2"], ["env1", "env2"]
        , ["context1", "context2"], ["branch1", "branch2"],True, ["interval1", "interval2"],True, [1, 1],
        ["hooks1", "hooks2"], ["work_dir1", "work_dir2"],["target_node_group1", "target_node_group2"],
 )
    client._get.assert_called_with(
        "EditProject",
...
def test_update(client):
    ...
    response = client.Build.Update(
        "env_name",1, [1,1],["context1","context2"])
    assert response == success_response
    client._get.assert_called_with(
        "Update",
        params={
