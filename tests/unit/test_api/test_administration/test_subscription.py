...
def test_adjust_product(client):
    client._get.return_value = success_response
    response = client.Subscription.AdjustProduct(1, 1, 1, "ruk")
    client._get.assert_called_with(
        "AdjustProduct",
        params={"subscriptionId": 1, "itemId": 1, "itemResourceId": 1, "ruk": "ruk"},
    )
    assert response == success_response
...
def test_delete_category(client):
    client._get.return_value = success_response
    response = client.Subscription.DeleteCategory(1, 1, "ruk")
    client._get.assert_called_with(
        "DeleteCategory", params={"id": 1, "resellerId": 1, "ruk": "ruk"}
    )
    assert response == success_response
...
def test_delete_product(client):
    client._get.return_value = success_response
    response = client.Subscription.DeleteProduct(1, 1, "ruk")
    client._get.assert_called_with(
        "DeleteProduct", params={"id": 1, "resellerId": 1, "ruk": "ruk"}
    )
    assert response == success_response
...
def test_delete_service_plan(client):
    client._get.return_value = success_response
    response = client.Subscription.DeleteServicePlan(1, 1, "ruk")
    client._get.assert_called_with(
        "DeleteServicePlan",
        params={"id": 1, "resellerId": 1, "ruk": "ruk"},
    )
    assert response == success_response
...
def test_edit_category(client):
    client._get.return_value = success_response
    response = client.Subscription.EditCategory(1, 1, "ruk")
    client._get.assert_called_with(
        "EditCategory",
        params={"category": 1, "resellerId": 1, "ruk": "ruk"},
    )
    assert response == success_response
...
def test_get_categories(client):
    client._get.return_value = success_response
    response = client.Subscription.GetCategories(1, "exp", "ruk")
    client._get.assert_called_with(
        "GetCategories", params={"resellerId": 1, "expendFields": "exp", "ruk": "ruk"}
    )
    assert response == success_response
...
def test_get_service_plan(client):
    ...
    response = client.Subscription.GetServicePlans(
        1, True, ["sub1", "sub2", "sub3", "sub4"], 1, "exp", 1, "ruk"
    )
    client._get.assert_called_with(
        "GetServicePlans",
        params={
...
def test_set_category_published(client):
    client._get.return_value = success_response
    response = client.Subscription.SetCategoryPublished(1, True, 1, "ruk")
    client._get.assert_called_with(
        "SetCategoryPublished",
        params={"id": 1, "published": True, "resellerId": 1, "ruk": "ruk"},
    )
    assert response == success_response
...
def test_set_product_status(client):
    client._get.return_value = success_response
    response = client.Subscription.SetProductStatus(1, "status", 1, "ruk")
    client._get.assert_called_with(
        "SetProductStatus",
        params={"id": 1, "status": "status", "resellerId": 1, "ruk": "ruk"},
    )
    assert response == success_response
...
def test_set_service_plan_status(client):
    client._get.return_value = success_response
    response = client.Subscription.SetServicePlanStatus(1, "status", 1, "ruk")
    client._get.assert_called_with(
...
def test_terminate_subscription(client):
    client._get.return_value = success_response
    response = client.Subscription.TerminateSubscription(1, "password", "ruk")
    client._get.assert_called_with(
        "TerminateSubscription",
        params={"subscriptionId": 1, "password": "password", "ruk": "ruk"},
    )
    assert response == success_response
