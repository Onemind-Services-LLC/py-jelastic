...
def test_create_project(client):
    ...
    response = client.Vcs.CreateProject(
        "env_name", "type","context","url",["branch1","branch2"], [1,2],
        ["login1", "login2"],["password1","password2"],[True,True],
        ["interval1", "interval2"],[True,True],[True,True],[True,True],["node_group1","node_group2"],
        ["hooks1", "hooks2"],[1,1], ["repo_hash1","repo_hash2"]
    )
    client._get.assert_called_with(
        "CreateProject",
        params={
...
def test_edit_project(client):
    ...
    response = client.Vcs.EditProject(
        "env_name", "type","oldcontext","newcontext","url","branch",True,True,True, [1,2],
        ["login1", "login2"],["password1","password2"],
        ["interval1", "interval2"],["node_group1","node_group2"],
        ["hooks1", "hooks2"],[1,1], ["repo_hash1","repo_hash2"]
    )
    client._get.assert_called_with(
        "EditProject",
