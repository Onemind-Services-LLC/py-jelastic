...
def test_tariff_create_grid(client):
    ...
    response = client.Tariff.CreateGrid(
        {"name": "test"},
        1,
        "ruk",
    )
...
def test_tariff_create_grid_item(client):
    client._get.return_value = success_response
    response = client.Tariff.CreateGridItem(
        {"name": "test"},
        1,
        "ruk",
    )
...
def test_tariff_delete_grid(client):
    client._get.return_value = success_response
    response = client.Tariff.DeleteGrid(
        "test",
        1,
        "ruk",
    )
...
def test_tariff_delete_grid_item(client):
    client._get.return_value = success_response
    response = client.Tariff.DeleteGridItem(
        "test",
        1,
        "ruk",
    )
...
def test_tariff_edit_grid(client):
    client._get.return_value = success_response
    response = client.Tariff.EditGrid(
        {"name": "test"},
        1,
        "ruk",
    )
...
def test_tariff_edit_grid_item(client):
    client._get.return_value = success_response
    response = client.Tariff.EditGridItem(
        {"name": "test"},
        1,
        "ruk",
    )
...
def test_tariff_get_grid_items(client):
    client._get.return_value = success_response
    response = client.Tariff.GetGridItems(
        "test",
        1,
        "ruk",
    )
