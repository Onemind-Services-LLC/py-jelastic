...
def test_allow_app_access(client):
    client._get.return_value = success_response
    response = client.Applications.AllowAppAccess("target_appid", "allow_appid")
    client._get.assert_called_with(
        "AllowAppAccess",
        params={
            "targetAppid": "target_appid",
...
def test_solution_app_info(client):
    client._get.return_value = success_response
    response = client.Applications.ChangeSolutionInfo("target_appid", "field", "value")
    client._get.assert_called_with(
        "ChangeSolutionInfo",
...
def test_clean_owner_cache(client):
    client._get.return_value = success_response
    response = client.Applications.CleanOwnerCache(1, True)
    client._get.assert_called_with(
        "CleanOwnerCache",
        params={
            "userId": 1,
...
def test_confirm_app_transfer_request(client):
    client._get.return_value = success_response
    response = client.Applications.ConfirmAppTransferRequest("key")
    client._get.assert_called_with(
...
def test_create_apps_pool(client):
    client._get.return_value = success_response
    response = client.Applications.CreateAppsPool("name")
    client._get.assert_called_with(
        "CreateAppsPool",
        params={"name": "name"},
    )
...
def test_create_confirm_app_transfer_key(client):
    client._get.return_value = success_response
    response = client.Applications.CreateConfirmAppTransferKey("email")
    client._get.assert_called_with(
...
def test_create_solution(client):
    client._get.return_value = success_response
    response = client.Applications.CreateSolution("target_appid")
    client._get.assert_called_with(
        "CreateSolution",
        params={
            "targetAppid": "target_appid",
...
def test_delete_app(client):
    client._get.return_value = success_response
    response = client.Applications.DeleteApp("password", "target_appid")
    client._get.assert_called_with(
        "DeleteApp",
        params={
            "password": "password",
...
def test_delete_apps_pool(client):
    client._get.return_value = success_response
    response = client.Applications.DeleteAppsPool("name")
    client._get.assert_called_with(
        "DeleteAppsPool",
        params={"name": "name"},
    )
...
def test_delete_solution(client):
    client._get.return_value = success_response
    response = client.Applications.DeleteSolution("target_appid")
    client._get.assert_called_with(
        "DeleteSolution",
        params={
            "targetAppid": "target_appid",
...
def test_export_app_persistance(client):
    client._get.return_value = success_response
    response = client.Applications.ExportAppPersistance("target_appid")
    client._get.assert_called_with(
...
def test_export_app_resource(client):
    client._get.return_value = success_response
    response = client.Applications.ExportAppResources("target_appid")
    client._get.assert_called_with(
        "ExportAppResources",
        params={
            "targetAppid": "target_appid",
...
def test_get_app(client):
    client._get.return_value = success_response
    response = client.Applications.GetApp("target_appid")
    client._get.assert_called_with(
        "GetApp",
        params={
            "targetAppid": "target_appid",
...
def test_get_app_access(client):
    client._get.return_value = success_response
    response = client.Applications.GetAppAccess("target_appid")
    client._get.assert_called_with(
        "GetAppAccess",
        params={
            "targetAppid": "target_appid",
...
def test_get_app_home(client):
    ...
    client._get.assert_called_with("GetAppHome", params={})
    assert response == success_response


def test_get_app_permission(client):
    client._get.return_value = success_response
    response = client.Applications.GetAppPermission("target_appid")
    client._get.assert_called_with(
        "GetAppPermission",
        params={
            "targetAppid": "target_appid",
...
def test_get_apps(client):
    client._get.return_value = success_response
    response = client.Applications.GetApps("target_appid")
    client._get.assert_called_with(
        "GetApps",
        params={
            "targetAppid": "target_appid",
...
def test_get_apps_by_login(client):
    client._get.return_value = success_response
    response = client.Applications.GetAppsByLogin("login")
    client._get.assert_called_with(
        "GetAppsByLogin",
        params={
            "login": "login",
...
def test_get_confirm_app_transfer_key(client):
    ...
    client._get.assert_called_with("GetConfirmAppTransferKey", params={})
    assert response == success_response


def test_get_confirm_app_transfer_keys(client):
    client._get.return_value = success_response
    response = client.Applications.GetConfirmAppTransferKeys(["appid1", "appid2"])
    client._get.assert_called_with(
...
def test_get_shared_apps_by_login(client):
    client._get.return_value = success_response
    response = client.Applications.GetSharedAppsByLogin("login")
    client._get.assert_called_with(
...
def test_get_shared_apps_by_owner_login(client):
    client._get.return_value = success_response
    response = client.Applications.GetSharedAppsByOwnerLogin("owner_login", "login")
    client._get.assert_called_with(
...
def test_get_shared_apps_by_owner_logins(client):
    client._get.return_value = success_response
    response = client.Applications.GetSharedAppsByOwnerLogins("owner_login", "logins")
    client._get.assert_called_with(
...
def test_get_solution(client):
    client._get.return_value = success_response
    response = client.Applications.GetSolution("target_appid")
    client._get.assert_called_with(
        "GetSolution",
        params={
            "targetAppid": "target_appid",
...
def test_is_apps_installed(client):
    ...
    client._get.assert_called_with("IsAppsInstalled", params={})
    assert response == success_response


def test_rebuild_app(client):
    client._get.return_value = success_response
    response = client.Applications.RebuildApp("target_appid")
    client._get.assert_called_with(
        "RebuildApp",
        params={
            "targetAppid": "target_appid",
...
def test_remove_app_access(client):
    client._get.return_value = success_response
    response = client.Applications.RemoveAppAccess("target_appid", "allow_appid")
    client._get.assert_called_with(
        "RemoveAppAccess",
...
def test_rebuild_app_from_pool(client):
    client._get.return_value = success_response
    response = client.Applications.RemoveAppFromPool("name", "target_appid")
    client._get.assert_called_with(
        "RemoveAppFromPool",
        params={
            "name": "name",
