...
def test_attach_env(client):
    ...
    response = client.Group.AttachEnv(
        "env_name","env_group", ["target_appid1","target_appid2"],[1,1],
    )
    client._get.assert_called_with(
        "AttachEnv",
        params={
...
def test_create_group(client):
    ...
    response = client.Group.CreateGroup(
        "env_name","env_group",  {"data1":"data1","data2":"data2"},[1,1],
    )
    client._get.assert_called_with(
        "CreateGroup",
        params={
...
def test_edit_group(client):
    ...
    response = client.Group.EditGroup(
        "env_name","src_group_name", ["dst_group_name1","dst_group_name2"], {"data1":"data1","data2":"data2"},[1,1],
    )
    client._get.assert_called_with(
        "EditGroup",
        params={
...
def test_get_groups(client):
    ...
    response = client.Group.GetGroups(
        "env_name", ["target_appid1","target_appid2"],[1,1],
    )
    client._get.assert_called_with(
        "GetGroups",
        params={
